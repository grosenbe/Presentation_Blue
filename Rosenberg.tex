...
%% Maybe a slide here to describe the state of the company whenn I joined it?
%% IE, that on the PV side (and really CSP as well), we didn't have any technical people.
%% I was THE technical guy on the PV team, so I had to learn quickly and be resourceful.
%% The company's business model at the time allowe this, because the company still thought of itself as a power development company first, tech development a distant second
...
\begin{tikzpicture}[node distance = 0.6cm, thick, nodes = {align = center},
  ...
  \node[fill = light_blue, below = of Frame_Logger] (PNG)
       {Images Saved as PNG};
  \node[fill = light_blue, right = 1.5 of PNG] (Timestamp_Log)
  ...
  \path[very thick, USB, hv] (Camera.south) edge[->] (Image);
